...
//						message);
				...
				Log.e(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"è¡?]:"+
						message);
			}
		}
	}
	...
	public static void d(String message) {
		if (DEBUG_D) {
			...
			if (elements.length < 3) {
				...
				String methodName = elements[3].getMethodName();
				int lineNumber = elements[3].getLineNumber();
//				Log.d("TAG",className + "." + methodName + "():" + lineNumber+"ï¼?"+
//						message);
				
				Log.d(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"è¡?]:"+
						message);
			}
		}
	}
...
//						message);
				Log.i(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"è¡?]:"+
						message);
			}
		}
	}
...
//						message);
				Log.w(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"è¡?]:"+
						message);
			}
		}
	}
	...
	public static void v(String message) {
		if (DEBUG_V) {
			...
			if (elements.length < 3) {
				...
				Log.v(TAG,"["+className + ":"+methodName +" _ "+ lineNumber+"è¡?]:"+
						message);
